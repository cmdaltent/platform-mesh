...
func (in *IdentityProviderConfigurationSpec) DeepCopyInto(out *IdentityProviderConfigurationSpec) {
	*out = *in
	...
	if in.UpstreamIdentityProviders != nil {
		in, out := &in.UpstreamIdentityProviders, &out.UpstreamIdentityProviders
		*out = make([]UpstreamIdentityProvider, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *IdentityProviderConfigurationStatus) DeepCopyInto(out *IdentityProviderConfigurationStatus) {
	*out = *in
	...
	if in.ManagedUpstreamIdentityProviders != nil {
		in, out := &in.ManagedUpstreamIdentityProviders, &out.ManagedUpstreamIdentityProviders
		*out = make(map[string]UpstreamIdentityProviderStatus, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpstreamIdentityProviderStatus) DeepCopyInto(out *UpstreamIdentityProviderStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpstreamIdentityProviderStatus.
func (in *UpstreamIdentityProviderStatus) DeepCopy() *UpstreamIdentityProviderStatus {
	if in == nil {
		return nil
	}
	out := new(UpstreamIdentityProviderStatus)
	in.DeepCopyInto(out)
	return out
}
